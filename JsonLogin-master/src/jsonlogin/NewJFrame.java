...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        JSONArray jrr = new JSONArray();//bind diffrent user and pass together so they can be fetched one after another//array variable
        JSONParser jp = new JSONParser();
        try{
            FileReader file = new FileReader("UserData.json");//we need to have data from the beginning od variable assignment
            jrr=(JSONArray)jp.parse(file);
        }catch(Exception ex){
            JOptionPane.showMessageDialog(null,"Error occured");
        }
        
        obj.put("Username", jTextField1.getText());//appending username & password inside JSON object
        obj.put("Password",jTextField2.getText());
           //JOptionPane.showMessageDialog(null,obj);
        jrr.add(obj);
         //JOptionPane.showMessageDialog(null,jrr);
        try{
            FileWriter file = new FileWriter("UserData.json");//to file save
        ...
        for(int i=0;i<size;i++){
            if(obj.equals(jrr.get(i))){
                try{
                    ...
                    jrr.remove(i);
                    file.write(jrr.toJSONString());//when match found we have to write in the file
                    file.close();
                }catch(Exception ex){
                    JOptionPane.showMessageDialog(null,"Error occured");
                }
